...
public class VideoActivity extends Activity {
    ...
    private void playVideo(MediaItem mediaItem, MediaSource mediaSource, Boolean sphereView) {
        ...
        player.addListener(new Player.Listener() {
            ...
            public void onTracksChanged(Tracks tracks) {
                ...
                if (subtitlesEnabled && !captionSelectionApplied) {
    ...
    private void applyCaptionTrackSelection() {
        ...
        for (int rendererIndex = 0; rendererIndex < mapped.getRendererCount(); rendererIndex++) {
            ...
            builder.setRendererDisabled(rendererIndex, !subtitlesEnabled);
            builder.setPreferredTextLanguage("en");
            builder.setSelectUndeterminedTextLanguage(true);
            if (subtitlesEnabled) {
                DefaultTrackSelector.SelectionOverride override = chooseCaptionOverride(mapped, rendererIndex, groups);
                if (override != null) {
            ...
            AppLog.i(this, TAG, "Caption renderer " + (subtitlesEnabled ? "enabled" : "disabled")
